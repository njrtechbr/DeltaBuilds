...
export const builds: Build[] = [
  {
    ...
    favoritedBy: ['u2', 'u3'],
    versions: [
       { version: '2.1', shareCode: 'A7B3C9-X1Y2Z3-NEW', patchNotes: 'Updated for the latest season. Swapped the stock for better recoil control.', createdAt: '2024-05-20T09:00:00Z', isValid: true },
       { version: '2.0', shareCode: 'A7B3C9-X1Y2Z3-OLD', patchNotes: 'Initial release for the season.', createdAt: '2024-05-15T11:00:00Z', isValid: true },
    ]
  },
  {
    id: 'b2',
